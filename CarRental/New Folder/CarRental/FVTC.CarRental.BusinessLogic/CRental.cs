    ...
    public class CRental
    {
        ...
        public void Insert()
        {
            try
            {
                ...
                otblTransaction.ReturnDate = returndate;
                otblTransaction.RentalCharge = rentalcharge.ToString("C");
                otblTransaction.FuelCharge = fuelcharge.ToString("C");
                otblTransaction.ExcessMilesCharge = excessmilescharge.ToString("C");
                otblTransaction.TotalCharge = totalcharge.ToString("C");
 ...
 */
 ...
 returndate = (DateTime)otblTransaction.ReturnDate;
                /* This section is also not used.
